...
return {
  ...
  {
    'jdurand/claudecode.nvim',
    branch = 'feat/external-terminal-cmd-function',
        ...
        terminal = {
          ...
          provider_opts = {
            ...
            external_terminal_cmd = function(cmd)
              ...
              vim.notify(string.format("Neovim window: %d cols × %d rows (ratio: %.2f)", width, height, aspect_ratio), vim.log.levels.INFO)
