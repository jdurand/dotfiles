...
function Terminal.create_persistent_tui_script(command, options)
  ...
  local script_name = "launch_" .. command .. ".sh"
  ...
  script_content = script_content .. "# Find " .. command .. " executable\n"
  script_content = script_content .. "COMMAND_PATH=\"\"\n"
  script_content = script_content .. "for path in /opt/homebrew/bin/" .. command .. " /usr/local/bin/" .. command .. " /usr/bin/" .. command .. " $(which " .. command .. " 2>/dev/null); do\n"
  ...
  script_content = script_content .. "  echo \"" .. command .. " not found\"\n"
  script_content = script_content .. "  exit 1\n"
  script_content = script_content .. "fi\n\n"
  script_content = script_content .. "# Launch Kitty with " .. command .. " in a floating window\n"
  script_content = script_content .. "open -a kitty --args \\\n"
