# Generated by Powerlevel10k configuration wizard on 2022-08-16 at 16:02 EDT.
...
() {
  ...
  #
     ...
     typeset -g POWERLEVEL9K_DIR_CODE_FOREGROUND=31
     typeset -g POWERLEVEL9K_DIR_CODE_SHORTENED_FOREGROUND=103
     typeset -g POWERLEVEL9K_DIR_CODE_ANCHOR_FOREGROUND=39
  #
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 40 )) && branch[22,-12]="…"  # <-- this line
